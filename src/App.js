...
class App extends Component {
  ...
  onGenerateRandomImg = () => {
    ...
    const randomImg = imagesList[randomImgIndex].imageUrl
    this.setState({randomImgURL: randomImg})
  }
  ...
  renderGame = () => {
    const {randomImgURL} = this.state
    const filteredList = this.onDisplayFrits()
    return (
      <div className="bottum-container-alinement">
        <img alt="img" className="match-img" src={randomImgURL} />
        <ul className="tabs-alinement">
        ...
        <ul className="thumbnail-alinement">
  ...
  renderScoreCard = () => {
    ...
    return (
      <div className="score-card-alinement">
  ...
  render() {
    const {score, isTimerRunning, currentSeconds} = this.state
    ...
    return (
      <div className="bg-container">
        <div className="nav-bar">
          ...
          />
          <div className="score-and-timer-alinement">
            <div className="nav-bar-score-alinement">
            ...
            <div className="nav-bar-score-alinement">
              ...
              />
              <p className="score-count">{currentSeconds} sec</p>
            </div>
          </div>
        </div>
        {isTimerRunning ? this.renderGame() : this.renderScoreCard()}
      </div>
    )
  }
}
